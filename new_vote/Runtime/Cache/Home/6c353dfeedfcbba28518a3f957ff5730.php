...
<body>
<div class="click_share" style="display: none">
    <img src="/new_vote/Public/images/click_share.png" class="img-responsive center-block">
</div>
<div class="player_minute">
    <div class="player_info row">
        <div class="col-xs-4 img">
            <img src="/new_vote/Public/images/l_1.jpg" class="img-responsive center-block img-rounded" style="max-width: 90%">
        </div>
        <div class="col-xs-8 text">
            <h3>陈天华</h3>
            <p>参赛宣言：我自信，我出色；我拼搏，我成功！ 给失败装上一双翅膀，就能飞到成功的天堂。
            </p>
                <span class="num">
    001号
</span>
    ...
    <div class="player_img">
        <p><img src="/new_vote/Public/images/pl_1.jpg" class="img-responsive center-block"></p>
        <p><img src="/new_vote/Public/images/pl_1.jpg" class="img-responsive center-block"></p>
    </div>
    <div class="Ta">
        <div class="Ta_t">
            <button class="btn"><i class="i_1"></i> 投TA一票</button>
        </div>
        <div class="Ta_b">
            <button class="btn"><i class="i_2"></i>帮TA投票</button>
        </div>
    </div>
</div>
